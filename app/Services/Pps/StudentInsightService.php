...
class StudentInsightService
{
    ...
    public function buildContext(Student $student, ?User $viewer): array
    {
        ...
        return $base + [
            ...
            'second_guardian_profession' => $student->second_guardian_profession,
            'second_guardian_profession_category' => $student->second_guardian_profession_category,
            'second_guardian_time_availability' => $student->second_guardian_time_availability,
